            ...
            public static void ReadIncomingData() {
                ...
                while (instance.SerialComPort.BytesToRead >= 4) {
                    ...
                    if (Inputs[1] == decoderHighPort) {
                        ...
                        instance.RawControlCurrentTextBox.Text = dacCurrentValue.ToString();
                        instance.RawCurrentVoltageTextBox.Text = instance.CalculateVoltageFromBinary(dacCurrentValue).ToString();
                    }
